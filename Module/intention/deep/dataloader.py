...
import pandas as pd
from bert_utils import get_intent_labels, get_slot_labels
...
class InputExample(object):
    def __init__(self, guid, words, intent_label = None, slot_lables = None):
        self.guid = guid
        self.words = words
        self.intent_label = intent_label
        self.slot_lables = slot_lables
...
class JointProcessor(object):
    ...
    def __init__(self, config):
        self.args = config
        self.intent_labels = get_intent_labels(config)
        self.slot_labels = get_slot_labels(config)
...
class intent_dataset:
    def __init__(self, df: pd.DataFrame, tokenizer, max_len: int, config: dict):
        self.df = df
        self.tokenizer = tokenizer
        self.max_len = max_len
        self.classes = df[config['output_column']].unique().tolist()
        self.y = df[config['output_column']]
        self.x = df[config['input_column']]
